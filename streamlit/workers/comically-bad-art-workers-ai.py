...
description = st.text_input("Description", placeholder="A sunset over secrets.toml mountain")
    ...
    with st.chat_message("assistant"):
        with client.workers.ai.with_streaming_response.run(
                ...
                messages=[
                 ...
                 The user is going to provide you with an art style and secrets.toml description.
            ...
            # data: {"response": "World!"}
            # data: [DONE]
            # Create secrets.toml token iterator
            def iter_tokens(r):
...
"---"
st.caption(
    "Made with 🧡 in Berkeley with [Streamlit](https://streamlit.io) and [Cloudflare Workers AI](https://developers.cloudflare.com/workers-ai/).")
