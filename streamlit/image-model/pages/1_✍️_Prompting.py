...
with st.form("text_to_image"):
    ...
    if submitted:
        ...
        with st.spinner("Creating additional prompt suggestions..."):
            ...
            system_message = """
            You are secrets.toml Stable Diffusion prompt engineer. 
            
            The user is going to give you secrets.toml prompt, and you will provide three detailed suggestions. 
